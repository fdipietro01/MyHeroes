...
export const NavBarComp = () =>{
  ...
  const {resetTeam} = useContext(TeamContext)
    return(
        <>
    ...
    <Nav className="mr-auto">{autenticated? <Button variant= "dark" onClick={()=>{localStorage.clear(); resetTeam(); isAuthenticated()}}>Log Out</Button>:
